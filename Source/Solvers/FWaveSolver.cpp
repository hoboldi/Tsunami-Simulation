...
RealType Solvers::FWaveSolver::calculateHRoe(std::vector<RealType> leftState, std::vector<RealType> rightState) {
...
std::vector<RealType> Solvers::FWaveSolver::calculateEigenvalues(
...
std::vector<RealType> Solvers::FWaveSolver::calculateAlphas(
  ...
  std::vector<RealType> effectOfBathymetry) {
  std::vector<RealType> deltaFlux = subtractVectors(evaluateFluxFunction(rightState),
...
std::vector<RealType> Solvers::FWaveSolver::calculateEffectOfBathymetry(
  std::vector<RealType> leftState, std::vector<RealType> rightState, RealType leftBathymetry,
...
std::vector<std::vector<RealType>> Solvers::FWaveSolver::calculateNetUpdate(
  std::vector<RealType> alphas, std::vector<RealType> eigenvalues
) {

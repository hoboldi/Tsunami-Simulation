...
namespace Blocks {
  ...
  public:
     ...
     */
    WavePropagationBlock1D(RealType* h, RealType* hu, RealType* b, unsigned int size, RealType cellSize);
    ~WavePropagationBlock1D();
